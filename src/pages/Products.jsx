...
export default function ProductsPage() {
  ...
  return (
    <main className="bg-[#f5f5f5] flex flex-col  justify-center items-center ">
      <div className="m-4">
        <h1 className="text-6xl text-center  text-[#1e3a8a]">Our Products</h1>
      </div>
        ...
        {products.map(
          ({ id, name, originalPrice, currentPrice, category, image }) => {
            return (
              <Card
                key={id}
                className="h-full border-2 border-gray-200 rounded-lg shadow-md flex flex-col justify-center items-center"
              >
                <Card.Img
                  variant="top"
                  src={image}
                ...
                />
                <Card.Body className="p-2 flex flex-col justify-center items-center">
                  <Card.Title className="text-lg text-center font-semibold mb-2 text-[#1e3a8a]">
                    {name}
                  </Card.Title>
                  ...
                  <div className="flex items-center">
                    <Button
                      variant="primary"
                      className="bg-[#1e3a8a] text-white  px-2 p-1 border-0 rounded"
                      onClick={() =>
