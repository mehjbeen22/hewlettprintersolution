...
const HelpPage = () => {
  return (
    <main className="bg-[#f5f5f5] flex items-center justify-center py-6">
      <div className="bg-white p-8 rounded-lg w-11/12 max-w-6xl mx-auto text-center shadow-xl">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-center justify-center p-4 bg-gray-100 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            <MonitorIcon style={{ color: '#1e3a8a' }} fontSize="large" />
          ...
          <div className="flex items-center justify-center p-4 bg-gray-100 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            <WifiIcon style={{ color: '#1e3a8a' }} fontSize="large" />
            <p className="text-lg text-gray-700 ml-4">WiFi & Networks</p>
          </div>

          <div className="flex items-center justify-center p-4 bg-gray-100 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            <RadioIcon style={{ color: '#1e3a8a' }} fontSize="large" />
