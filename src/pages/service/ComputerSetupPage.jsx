          ...
          <div className="w-full md:w-1/2">
            ...
            <section className="space-y-4">
              ...
              <div className="flex items-center mb-6 p-4 bg-gray-100 rounded-lg shadow-md">
                ...
                <Link to="/Computeradskuform">
                  <button className="ml-4 px-4 py-2 bg-[#1e3a8a] text-white rounded-md hover:bg-[#163075]">
                    BOOK NOW
                  </button>
                </Link>
              </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  `Depending on the nature of your request we may be able to offer instant support through        HelloTech Now! online assistance. An agent will create a secure connection to 
                your computer and troubleshoot the issue right before your eyes.`,
                ].map((text, index) => (
                  <p
                    key={index}
